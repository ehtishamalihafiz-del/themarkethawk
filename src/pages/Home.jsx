...
export default function Home() {
  ...
  <div className="pointer-events-none absolute inset-0 h-full overflow-hidden">
    ...
    <div className="absolute bottom-0 -left-20 h-40 w-40 rounded-full bg-emerald-400/20 blur-3xl md:-left-32 md:h-80 md:w-80" />
    <div className="absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-600/10 blur-3xl md:h-[700px] md:w-[700px]" />
  ...
  <div className="relative mx-auto max-w-7xl sm:px-6 lg:px-8">
    <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
      ...
      <div className="text-center lg:text-left">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-green-400/30 bg-green-500/20 px-4 py-2 text-xs font-semibold text-green-300 backdrop-blur-sm md:mb-6 md:text-sm">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center md:mt-8 lg:justify-start">
          <button
            ...
            className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-green-400 px-7 py-3 text-base font-bold text-green-950 shadow-lg shadow-green-900/40 transition-all duration-200 hover:bg-green-300 hover:scale-105 active:scale-95 md:px-8 md:py-4"
          >
            Shop Now
      ...
      <div className="relative mx-auto mt-8 flex h-[260px] w-full max-w-[320px] items-center justify-center lg:h-[480px] lg:max-w-none">
        ...
        <div className="absolute top-6 left-4 z-20 -rotate-6 rounded-2xl bg-white px-4 py-3 shadow-xl transition-transform duration-300 hover:rotate-0">
          <p className="text-xs text-gray-500">Orders Today</p>
          <p className="text-lg font-black text-green-700">+238 🎉</p>
        </div>

        <div className="absolute right-0 bottom-8 z-20 rotate-3 rounded-2xl bg-white px-4 py-3 shadow-xl transition-transform duration-300 hover:rotate-0">
          <p className="text-xs text-gray-500">Delivery</p>
          <p className="text-lg font-black text-emerald-700">2–5 Days 🚚</p>
        </div>

        <div className="absolute top-1/2 -left-4 z-20 -rotate-3 rounded-2xl bg-green-600 px-4 py-3 text-white shadow-xl transition-transform duration-300 hover:rotate-0">
