        ...
        <div className="mx-auto max-w-6xl">
                ...
                <div className="flex flex-col">
                    <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm lg:p-8">
                        ...
                        <div className="flex items-end gap-3">
                            ...
                            {p.old_price && (
                                <>
                                    <del className="mb-1 text-lg text-gray-400">
                                        {currency(p.old_price)}
                                    </del>
                        ...
                        <div className="flex flex-col gap-3">
                            <button
                                ...
                                disabled={!inStock}
                                className={`flex w-full items-center justify-center gap-2 rounded-2xl py-3.5 text-base font-bold transition-all duration-200 active:scale-95 ${
                                    added
                        ...
                        <div className="mt-6 rounded-2xl border bg-gray-50 p-5">
                            <h2 className="mb-3 font-bold">Product Description</h2>
            ...
            {showCartPopup && addedProduct && (
                <div className="fixed inset-0 z-50 flex items-end bg-black/50">
                    <div className="w-full rounded-t-3xl bg-white p-4 shadow-2xl sm:p-5">
                        ...
                        <div className="flex gap-4 py-4">
                            <img
                                src={addedProduct.image_url || selectedImage || 'https://placehold.co/100x100?text=No+Image'}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className="rounded-xl bg-gray-100 py-3 text-sm font-black uppercase tracking-wider text-gray-900 transition hover:bg-gray-200"
                            >
                                View Cart
                            </button>
                            ...
                            <button
                                ...
                                className="rounded-xl bg-green-600 py-3 text-sm font-black uppercase tracking-wider text-white transition hover:bg-green-700"
                            >
                                Check Out
                            </button>
                        </div>
